...
export const updateAd        = (id,d)  => req('PUT',`/api/ads/${id}`,d)
export const updateBanner    = (id,d)  => req('PUT',`/api/banners/${id}`,d)
export const getProfile      = ()      => req('GET','/api/profile')
export const updateProfile   = (d)     => req('PATCH','/api/profile',d)
export const getAllFeedback   = ()      => req('GET','/api/feedback/all')

export const getPointsTiers  = ()      => req('GET','/api/points/tiers')
export const redeemPoints    = (pts)   => req('POST','/api/points/redeem',{points_to_spend:pts})

export const getAllReviews = () => req('GET','/api/reviews/all')

export const getGMBStatus      = (brandId)  => req('GET',  `/api/gmb/status/${brandId}`)
export const getGMBConnectURL  = (brandId)  => req('GET',  `/api/gmb/connect/${brandId}`)
export const disconnectGMB     = (brandId)  => req('POST', `/api/gmb/disconnect/${brandId}`)
export const gmbCheckNow       = (brandId)  => req('POST', `/api/gmb/check-now/${brandId}`)
